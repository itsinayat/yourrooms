...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) {
		...
		configurationRepository.save(new Configuration(1L,"IM_PRIVATE_KEY","test_c0fe7a31708c15d1d1fd548d88c"));
		configurationRepository.save(new Configuration(1L,"IM_AUTH_TOKEN","test_75914bf49a32ffaaee32bf441b8"));
		configurationRepository.save(new Configuration(1L,"IM_SALT","fb7d6875d700457198525b308bcd1d52"));
